...
public class ExampleJLoadScenarioProvider extends JaggerPropertiesProvider {
    ...
    @Bean
    public JLoadScenario exampleJaggerLoadScenario_() {
        ...
        return JLoadScenario.builder(Id.of("exampleJaggerLoadScenario_"), jParallelTestsGroup)
    ...
    @Bean
    public JLoadScenario myFirstJaggerLoadScenario_() {
        ...
        return JLoadScenario.builder(Id.of("myFirstJaggerLoadScenario_"), testGroup).build();
    }
}